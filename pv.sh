...
for f in images/fishchuck___2013-08-05_15-2*
...
#         convert -background gray10 -fill white -size 1600x1200 -pointsize 72   -annotate +28+68 'Anthony'    jpg:- | convert -  -gravity center $rc_filename -gravity NorthWest  -composite \( $f -resize 640x480 \) -gravity SouthEast  -composite  monts/montage__$plain_filename.jpg 
        echo $text | convert -size 1600x1200 xc:gray10  -pointsize 32 -fill White -gravity NorthEast  -annotate +200+100 '@-'   jpg:- | convert -  -gravity center $rc_filename -gravity NorthWest  -composite \( $f -resize 640x480 \) -gravity SouthEast  -composite  monts/montage__$plain_filename.jpg 
...
cat monts/*.jpg | ffmpeg -f image2pipe -r 15 -vcodec mjpeg -i - -target pal-dvd  out.mp
